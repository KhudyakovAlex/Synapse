...
3.8. **Действие (ACTION)** — единовременное изменение состояния системы освещения. Действие может включать неограниченное количество изменений различных параметров: изменение состояния светильников, активация/деактивация датчиков... Действия навешиваются на нажатия кнопок, сработки датчиков, события в расписании.
