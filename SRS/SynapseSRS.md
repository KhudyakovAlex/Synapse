...
18.9. Кнопки включения глобальных сцен.
...
19.3. Страницы Локация 1 ... Локация N — оперативное управление светильниками локации, настройка датчиков и кнопок локации, расписание.
...
- Найденные новые по признаку "SYNAPSE XXXXXXXX" bluetooth-устройства (где XXXXXXXX — серийный номер контроллера). С таким названием и дефолтной иконкой.

20.1.1. (Проверить возможность вывода новых устройств тоже с измененными названиями и иконками — оставлять начало "SYNAPSE" всегда, дальше добавлять номер иконки, дальше наименование — парсить это и выводить как у подключавшихся контроллеров)
