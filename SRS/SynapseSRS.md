...
3.10. **Оперативное управление** — ручная установка пользователем яркости, цвета и температуры света светильников.
...
17.8. При пропадании связи с контроллером и нескольких безуспешных попыток ее восстановить приложение выкидывает пользователя в список контроллеров.
...
- Рабочие — необходимые для организации работы освещения и прошивке и приложению (помечены ниже жирным);
