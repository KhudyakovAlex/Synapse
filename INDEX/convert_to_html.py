...
<body>
    ...
    <div class="container" style="max-width: 1400px; margin: 0 auto; padding: 20px;">
        <!-- Sidebar -->
        <aside class="sidebar">
            <div style="background: var(--accent-primary); padding: 15px; margin: -20px -20px 20px -20px;">
                <a href="{root_path}index.html" style="display: block;">
                    <img src="{root_path}assets/img/Synapse_black.png" alt="Synapse" style="width: 100%; max-width: 200px;">
                </a>
            </div>
            <h3>📑 Содержание</h3>
            <ul>
