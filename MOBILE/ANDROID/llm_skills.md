...
- [x] Возвращать структурный ответ вида `assistantText + dbPatch + navigation`
...
- [x] Локации/контроллеры `CONTROLLERS`: `NAME`, `PASSWORD`, `IS_SCHEDULE`, `IS_GRAPHS`, `IS_AUTO`, `ICO_NUM`, `STATUS`, `SCENE_NUM`, `TIMESTAMP`, `GRID_POS`
