...
7.3. Если пользователь в локации, в рамках оперативного управления, кнопкой на стене или в телфоне включает любую сцену или меняет ярокость (у группы или отдельного светильника), сообщения от датчиков присутствия в этой локации о регистрации движения игнорируются до появления сигнала об отсутствии присутствия (тогда срабатывает действие повешеное на отсутствие и дальше всё идет в АВТО (если АВТО явно не отключено у датчика)).
...
8.3. Датчик по команде из приложения запоминает текущую освещенность как целевую.

7.3. Если пользователь в локации, в рамках оперативного управления, кнопкой на стене или в телфоне включает любую сцену или меняет ярокость (у группы или отдельного светильника), датчики освещенности в этой локации перестают поддерживать целевую освещенность до появления сигнала об отсутствии присутствия (тогда срабатывает действие повешеное на отсутствие и дальше всё идет в АВТО (если АВТО явно не отключено у датчика)).
...
10.4. Все локации находятся на одном уровне, никакой многоуровневой иерархии нет.
...
13.4. Действие универсально — несмотря на распложение инициирующего устройства может распространяться на любые локации и весь объект.
