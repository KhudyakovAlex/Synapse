# Техническое заданиеОбработать папку репозитория согласно инструкциям в project_process_prompt.md
...
17.3. Лесенка светодиодов загорается вся, если есть хотя бы одно bluetoth-соединение с телефоном. Иначе вся лесенка не горит.
