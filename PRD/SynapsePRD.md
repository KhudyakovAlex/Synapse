...
6.7. У локации есть флаг (в пользовательском интерфейсе приложения - тумблер в соотв. локации) — работает ли локация в автоматическом режиме по датчикам присутствия и освещённости. Если АВТО — выкл, сигналы от датчиков (и присутствия и освещенности), действующие на светильники в данной локации (не важно через индивидуальное управление, управление группами или локцией), игнорируются.
