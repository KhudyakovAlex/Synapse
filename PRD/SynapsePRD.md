...
12.2. Действие на присутствия срабатывает, когда датчик регистрирует присутствия при отсутствии присутствия до этого.
...
- любой датчик присутствия данной локации регистрирует присутствие;
- до этого момента ни один датчик присутствия не регистрировал присутствие.  
