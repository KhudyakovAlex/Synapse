...
14.1. Действия (ACTIONS) — изменения параметров системы уровня настройки и оперативного управления.
...
21.9. **Настройки датчика присутствия** — активация/деактивация, задержка, назначение действий при срабатывании, название, DALI-параметры, удаление датчика.

21.10. **Настройки датчика освещённости** — активация/деактивация, целевая освещённость, управляемая группа светильников, название, DALI-параметры, удаление датчика.

21.11. **Настройки кнопочной панели** — назначение действий на кнопки, название, удаление панели.

21.12. **Расписание** — редактирование расписания.
...
## 24. Приложение. Настройка

## 25. Приложение. Оперативное управление
