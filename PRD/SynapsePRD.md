...
2.4. Автоматическая работа освещения по датчикам движения и освещенности.
...
Действия навешиваются на нажатия кнопок, сработки датчиков движения, события в расписании.  
...
- Назначение действий на движение и отсутствие движения датчиков движения.
...
- Установка у датчиков движения: задержки (HOLD_TIME).
...
6.7. У локации есть флаг — работает ли локация в автоматическом режиме по датчикам движения и освещённости. Если АВТО — выкл, сигналы от датчиков, меняющие освещение в данной локации, игнорируются.
...
10.2. Типы устройств управления: датчики движения и освещенности, кнопочные панели.
...
12.1. На датчик навешиваются два действия (ACTIONS, см. ниже): на движ / на отсутствие движа.

12.2. Действие на движ срабатывает, когда датчик регистрирует движение при отсутствии движения до этого.

12.3. Действие на отсутствие срабатывает, когда датчик регистрирует отсутствие движа.

12.4. Если есть желание деактивировать конкретный датчик движения — убираем у него действия.
...
14.2. Навешиваются на нажатия кнопок, срабатывание датчиков движения, события расписания.
...
20.11. **Настройки датчика движения** — задержка (HOLD_TIME), назначение действий при срабатывании, название, DALI-параметры, удаление датчика.
