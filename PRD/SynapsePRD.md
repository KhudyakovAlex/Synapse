...
6.7. У локации есть флаг (в пользовательском интерфейсе приложения — тумблер в соответствующей локации) — работает ли локация в автоматическом режиме по датчикам присутствия и освещённости. Если АВТО — выкл, сигналы от датчиков (и присутствия, и освещённости), действующие на светильники в данной локации (не важно через индивидуальное управление, управление группами или локацией), игнорируются.
