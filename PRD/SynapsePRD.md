...
3.9. **Оперативное управление** — ручная установка пользователем яркости, цвета и/или температуры света светильников.
...
## 4. Пуско-наладка, настройка и оперативное управление. Разделение операций
...
- Установка у датчиков присутствия: задержки.
...
12.3. Действие на отсутствие срабатывает, когда у датчика заканчивается задержка.
...
14.1. Действия (ACTIONS) — изменения параметров системы уровня оперативного управления.

14.2. Навешиваются на нажатия кнопок, срабатывание датчиков присутствия, события расписания.

14.3. Действие может распространяться на любой набор светильников, датчиков, сцен, групп, локаций.
...
- **IS_BRIGHT_AUTO** — T/F — работает ли локация в автоматическом режиме по датчикам освещённости;
...
- **BRIGHTNESS** — пороговое значение освещённости.
...
21.11. **Настройки датчика присутствия** — задержка, назначение действий при срабатывании, название, DALI-параметры, удаление датчика.
...
- Хэлп по работе с интерфейсом приложения в частности (с переходом по запросу пользователя на нужные страницы интерфейса).

- Экскурсия по интерфейсу с объяснением назначения страниц и кнопочек.

- ПНР: инициализация и расширение линии DALI, создание локаций и групп светильников и т. п.
...
- Копирование настроек между однотипными локациями, группами светильников, устройствами одного типа и т. п.
