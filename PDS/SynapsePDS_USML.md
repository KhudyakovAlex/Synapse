...
2.2. Телеграммы в формате, описанном ниже, имеют хождение только со стороны приложения до конвертера. В конвертере они и на вход, и на выход переконвертируются в формат, одному богу и отделу Саенко известный.
...
4.1. **CONTR** (1) — работа с контроллером  
