...
3.5. В целях сокращения размера кода в прошивке, парсящего и формирующего телеги, зарезервированные слова во **внешних** телегах заменяются на соответствующие им числа: [1.1_2(25,"Этаж 2",IGlzIGRpc3RpdC)].
...
## 4. Телеграммы к USM (2) - работа с USM

## 5. Телеграммы к UI (3) - работа с пользовательским интерфейсом

## 6. Телеграммы к LLM (4) - работа с нейросеткой через чат 

## 7. Вопросы

7.1. Двоичные блоки кодируем в Base64?

7.2. Кодировку для кириллицы используем CP1251 (Windows-1251)?
