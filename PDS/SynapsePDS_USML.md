...
3.2.1.3. Формирование идёт строго в порядке, определённом в **SynapsePDS_FW_DB** — раздел 4 «Структура БД прошивки».
...
**Важно:** Передаём только изменившееся поле SCENE_NUM (п.2.5), а не все поля записей LOCATIONS
