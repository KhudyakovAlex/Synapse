...
3.2. Встречающиеся в теле телеги [ и ] экранируются: \[ и \].
...
- P — параметры (их набор зависит от трёх позиций выше):
  - целые числа в виде текстовых последовательностей цифр: 123;
  - тексты, помещённые в двойные кавычки: "Лампочка 12" (кавычки в тексте экранируются \");
...
5.1. Не являются ли телеги просто вызовами удалённых функций?
