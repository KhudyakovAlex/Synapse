...
2.3. В теле телеги могут иметь место разделямые пробелами:
...
2.5. В целях сокращения размера кода в прошивке, парсящего телеги, зарезервированные слова перед отправкой в контроллер заменяются на соотв. им числа: [1 2 63 "Свет.3" IGlzIGRpc3Rpbmd1aXNoZWQsIG5vdC].

2.6. Парсер принимает и понимает очередной элемент в телега на основе последовательности ранее принятых элементов. Например:
[
LUM (или 1) - у светильника
SET (или 2) - установить
63 - имеющего адрес 63
"Свет.3" - название такое
IGlzIGRpc3Rpbmd1aXNoZWQsIG5vdC - а это записать куда-то в его память
]

## 2. Вопросы

2.1. Двочные блоки кодируем в Base64?

2.2. Кодировку для кириллицы используем CP1251 (Windows-1251)?
