...
## 1. Изменение параметров устройств

1.1. Для изменения параметров DALI-устройств приложение отправляет телеграмму с изменением соответствующих полей в FW-USM.

1.2. Примеры параметров:
- **MIN_LEVEL**, **MAX_LEVEL** светильников;
- **FADE_TIME** светильников;
- **DELAY** (HOLD_TIME) датчиков присутствия.

1.3. Прошивка отправляет DALI-команду установки параметра устройству.
