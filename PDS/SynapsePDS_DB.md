...
erDiagram
    ...
    BUTTONS ||--o{ ACTIONS : "короткое нажатие"
    ...
    BUTTONS {
        ...
        INTEGER ACTION_SHORT_ID FK
        INTEGER ACTION_LONG_ID FK
        INTEGER DALI_ADDR
        INTEGER DALI_INST
        INTEGER ACTION_SHORT_NUM
...
- **VALUE** (INTEGER/**uint8_t**) — значение в зависимости от объекта:
    - если OBJECT_NUM из 0–96 — номер сцены;
    - если OBJECT_NUM из 100–196 — температура света;
    - если OBJECT_NUM из 201–216 — 0/1 (выкл/вкл).

3.14. **EVENTS** — события расписания.
...
1. Рабочие данные таки храним в Си или переносим в одну область с интерфейсными?

2. Как рабочие и интерфейсные данные будут попадать во флэш-память?

3. Не будет ли заморочным в смысле размера кода работать с бинарным блоком рабочих данных как с базой?

4. Нужно ли добиваться сокращения размера рабочих данных (упаковывания SCENE_LUMINAIRES и EVENTS в первую очередь) за счет увеличения кода, работающего с ними?
