...
### 4.5. Создание локаций и распределение по ним устройств

4.5.1. Создание, удаление и изменение локации производится по одной и той же телеге: SET.LOCATIONS[\<LOCID\>]. Проанализировав пришедшие поля записи, прошивка производит изменения у себя в USM и отправляет телеги об изменениях приложению.
