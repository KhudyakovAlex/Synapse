...
**Последнее изменение:** 13.12.2025, 08:19 МСК
...
```mermaid
graph TB
    subgraph SUBACTIONS["ПОДДЕЙСТВИЯ (SUBACTIONS)"]
        SUB1[Включить сцену 2<br/>в локации 1]
        SUB2[Установить TW=200<br/>в группе 3]
        SUB3[АВТО=1<br/>в локации 1]
    end
    
    subgraph ACTIONS["ДЕЙСТВИЯ (ACTIONS)"]
        ACT1[ACTION j<br/>"Вечерний свет"]
        ACT2[ACTION k<br/>"Утренний свет"]
        ACT3[ACTION m<br/>"Выключить всё"]
        ACT4[ACTION n<br/>"Ночник"]
    end
    
    subgraph TRIGGERS["НАЗНАЧАЮТСЯ НА"]
        BTN_SHORT[Кнопка i<br/>короткое нажатие<br/>набор действий]
        BTN_LONG[Кнопка i<br/>долгое нажатие]
        SENS_OCC[Датчик s<br/>присутствие]
        SENS_VAC[Датчик s<br/>отсутствие]
        EVENT[Событие e<br/>расписание]
    end
    ...
    ACT1 -.POS=1.-> BTN_SHORT
    ACT2 -.POS=2.-> BTN_SHORT
    ACT3 -.POS=3.-> BTN_SHORT
