...
**Последнее изменение:** 11.12.2025, 20:02 МСК
...
### 7.7. Именование и раздача имён и пиктограмм локациям, устройствам

7.7.1. Изменение имени/иконки локациям и устройствам — это изменение интерфейсных данных в блоке IDATA.

7.7.2. Приложение отправляет телеграмму с новым блоком IDATA.

7.7.3. Прошивка:
- Обновляет блок IDATA в FW-USM;
- Рассылает изменения всем телефонам.

цу для имени и иконки контроллера сделай отдельный подпункт. они хранятся в отдельных полях а не вidata.и к ним же добавить что может прийти из приложения новый пароль
