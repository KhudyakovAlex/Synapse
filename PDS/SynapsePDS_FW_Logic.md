...
**Последнее изменение:** 13.12.2025, 08:21 МСК
...
graph TB
    subgraph SUBACTIONS[ПОДДЕЙСТВИЯ SUBACTIONS]
        SUB1[Включить сцену 2 в локации 1]
        SUB2[Установить TW=200 в группе 3]
        SUB3[АВТО=1 в локации 1]
    end
    
    subgraph ACTIONS[ДЕЙСТВИЯ ACTIONS]
        ACT1[ACTION j Вечерний свет]
        ACT2[ACTION k Утренний свет]
        ACT3[ACTION m Выключить всё]
        ACT4[ACTION n Ночник]
    end
    
    subgraph TRIGGERS[НАЗНАЧАЮТСЯ НА]
        BTN_SHORT[Кнопка i короткое нажатие набор действий]
        BTN_LONG[Кнопка i долгое нажатие]
        SENS_OCC[Датчик s присутствие]
        SENS_VAC[Датчик s отсутствие]
        EVENT[Событие e расписание]
    end
