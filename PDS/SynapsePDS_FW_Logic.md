...
1.4. **USML** (Unit System Model Language) — система команд (телеграмм) для передачи данных в рамках АПК Синапс. Предназначен для общения LLM, мобильного приложения и прошивки контроллера. Описано в **[SynapsePDS_USML](SynapsePDS_USML.html)**.
...
2.7. Формат телеграмм, соответствие софт-телег и хард-телег и язык USML в целом описаны в **[SynapsePDS_USML](SynapsePDS_USML.html)**.
