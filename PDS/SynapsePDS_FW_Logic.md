...
цу CONTROLLERS.TIMESTAMP надо добавить в БД приложения
...
нб юсм передается приложению сразу после успешного подключения. проверять пароль дело приложения. контроллер просто передаёт пароль вместе со всем юсм. при неверном пароле от пользователей приложение само блокирует работу с контроллером
