...
4.1.1. Когда пользователь меняет что-то из чисто интрефейсных вещей, которые никак в управлении рсвещением не участвуют, (например меняет название светильника) это надо сохранить для потомков в контроллере в блоке IDATA.
