...
**Последнее изменение:** 12.12.2025, 11:35 МСК
...
7.11.2. Прошивка проверяет, что датчик и группа в одной локации (или оба в корне).

7.11.3. Прошивка последовательно переводит светильники группы в сцены 0-4 (DALI-команды).

7.11.4. Для каждой сцены N (0-4) прошивка:
...
7.12.3. Кнопка начинает отрабатывать действия при нажатиях.
