...
erDiagram
    ...
    LOCATIONS ||--o{ PRES_SENSORS : "LOCATION"
    LOCATIONS ||--o{ BRIGHT_SENSORS : "LOCATION"
    LOCATIONS ||--o{ BUTTON_PANELS : "LOCATION"
    ...
    ACTIONS ||--o{ BUTTONS : "NUM"
    ACTIONS ||--o{ PRES_SENSORS : "ACTION_OCCUPANCY_NUM/ACTION_VACANCY_NUM"
