...
- **DALI_INST** (, -1) — номер инстанса кнопки в DALI;
- **ACTION_LONG_ID** (INTEGER / -1) — действие по долгому нажатию; -1 — не повешено действие.
...
- ID (INTEGER / PK, 0..511) — идентификатор в соответствующем массиве в прошивке;
- **BUTTON_SHORT_ID** (INTEGER / 0..511) — кнопка, на короткое нажатие которой навешено действие; -1 — действие не привязано к короткому нажатию кнопки (может быть привязано к датчику или событию расписания);
