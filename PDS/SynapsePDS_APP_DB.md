...
- **ACTION_SET_SHORT_NUM** (INTEGER) — действие по короткому нажатию; -1 — не повешено действие;
...
- ID (INTEGER, PK) — идентификатор в соответствующем массиве в прошивке;
- **ACTION_SET_NUM** (INTEGER) — привязка к набору действий; если действие не входит ни в какой набор: -1;
