...
**Последнее изменение:** 26.12.2025, 07:27 МСК
...
P\controllers_nollm\TYPE:NEW\Контроллеры (ИИ откл)\IN:LT
...
P\controller_pass\Пароль контроллера\Страница ввода пароля контроллера
  F\OUT:LT\IN:H
...
P\controller\Контроллер\Разблокированный контроллер
  ...
  F\OUT:B\100%x48\#333333
    ...
    S\1\\\80x28\OUT:L:M10\Включение ИИ
    S\1\ICON:volume-2:24\ICON:volume-x:24\80x28\OUT:R:M10\Включение/отключение озвучки ИИ
P\llm\Чат с LLM\TYPE:NEW:G\Страница общения с ИИ-джином. Вернее, не страница, а выдвигающаяся поверх всего остального интерфейса панель с чатом ИИ.
  F\OUT:LT\IN:H
...
P\delete_controller\Удаление контроллера\TYPE:NEW:G
  F\100%x100%
    C\Для удаления контроллера перетащите его на эту иконку\80%x\OUT:M20
    F\IN:H
