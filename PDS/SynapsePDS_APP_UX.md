...
**Последнее изменение:** 30.12.2025, 14:04 МСК
...
P\controllers\Локации\TYPE:NEW\Список контроллеров (локаций), которые на связи, и те, к которым когда-то подключались\IN:LT

  # Навигация
  F\OUT:T\IN:H\100%x48
    I\ICON:back:36\48x48\OUT:LT:M10\#111111\Выход из приложения
    C\Локации\FONT:24\x48\OUT:LT\IN:NW\#333333\TYPE:NEW
  ...
  F\OUT:B\100%x48\#333333
    ...
    S\1\@GOTO:controllers_nollm\\80x28\OUT:L:M10\Включение ИИ
    S\1\ICON:volume-2:24\ICON:volume-x:24\80x28\OUT:R:M10\Включение/отключение озвучки ИИ


P\controllers_nollm\TYPE:NEW\Локации (ИИ откл)\IN:LT

  # Навигация
  F\OUT:T\IN:RT\100%x48
    I\ICON:sliders:36\48x48\OUT:M10\#111111
    C\Локации\FONT:24\x48\OUT:L\IN:NW\#333333\TYPE:NEW
  ...
  F\OUT:B\100%x48\#555555
    I\ICON:ai:24\48x48\OUT:M10\#AAAAAA\
    S\0\\@GOTO:controllers\80x28\OUT:L:M10\
    F\80x28\OUT:R:M10
...
P\settings\Настройки\Настройки приложения
  ...
  F\OUT:TL\IN:H
    ...
    I\ICON:trash:36\48x48\OUT:M10\#111111\GOTO:delete_controller\Удаление контроллера (перетаскиваем на неё)
...
P\controller_pass\Пароль локации\Страница ввода пароля контроллера
  ...
  # Панель ИИ
  F\OUT:B\100%x48\#333333
    I\ICON:ai:36\48x48\OUT:M10\GOTO:llm\#FFFFFF\
    S\1\\\80x28\OUT:L:M10\
...
P\delete_controller\Удаление локации\TYPE:G
  F\100%x100%
    C\Для удаления локации перетащите ее на эту иконку\80%x\OUT:M20
    F\IN:H
      I\ICON:check:48\64x64\OUT:M10\GOTO:settings
      I\ICON:close:48\64x64\OUT:M10\GOTO:settings
