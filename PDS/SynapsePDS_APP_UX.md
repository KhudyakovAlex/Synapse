...
**Последнее изменение:** 24.12.2025, 11:53 МСК
...
P\llm\Чат с LLM\Страница общения с ИИ-джином. Вернее, не страница, а выдвигающаяся поверх всего остального интерфейса панель с чатом ИИ.
  ...
  # Основной контент
  F\100%x100%
    C\Контент текущей страницы кнопочного интерфейса\FONT:16\#333333\Страница, поверх которой открывается ИИ-панель, может прокручиваться в пределах области экрана, которая ей остается. Прокручивается вместе с навигационной шапкой. При любом клике, кроме прокручивания на ней, панель ИИ сворачивается вниз и возвращаемся к исходному виду страницы.
