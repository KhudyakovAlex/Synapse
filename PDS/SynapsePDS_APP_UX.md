...
**Последнее изменение:** 04.02.2026, 15:06 МСК
...
P\add_controller\Добавление локации\TYPE:NEW\Поиск по блютусу новых контроллеров
...
P\llm\Чат с LLM\TYPE:G\Страница общения с ИИ-джином. Вернее, не страница, а выдвигающаяся поверх всего остального интерфейса панель с чатом ИИ.
  ...
  F\OUT:B\100%x48\#333333
    ...
    S\1\\AI\80x28\OUT:L:M10
    S\1\ICON:volume-2:24\ICON:volume-x:24\80x28\OUT:R:M10
P\lum_settimngs\Настройки светильника\Настройки светильника независимо от его типа
  F\OUT:LT\IN:H
    I\ICON:back:36\48x48\OUT:L:M10\#111111\GOTOBACK\Назад к управлению светильником
    C\Настройки светильника\FONT:24\x48\OUT:L\#333333
