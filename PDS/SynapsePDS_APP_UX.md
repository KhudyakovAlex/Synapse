...
**Последнее изменение:** 25.12.2025, 12:49 МСК
...
P\controller_pass\TYPE:NEW\Пароль контроллера\Страница ввода пароля контроллера
  F\OUT:LT\IN:H
...
P\delete_controller\TYPE:NEW\Удаление контроллера\TYPE:G
  F\100%x100%
