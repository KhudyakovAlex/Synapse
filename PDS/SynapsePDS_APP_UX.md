...
**Последнее изменение:** 06.02.2026, 15:39 МСК
...
P\add_controller\Добавление локации\Поиск по блютусу новых контроллеров
  ...
  C\Идет поиск контроллера локации...\FONT:16\x48\#333333

  F\100x130\OUT:M20
    I\ICON:box:100\100x100\#333333\OUT:T\GOTOBACK
    C\Этаж1\OUT:T:M0\IN:M0\#333333
...
P\llm\Чат с LLM\TYPE:G\Страница общения с ИИ-джином. Вернее, не страница, а выдвигающаяся поверх всего остального интерфейса панель с чатом ИИ.
  ...
  F\OUT:B\100%x48\#333333
    ...
    S\1\\AI\80x28\OUT:L:M10
    S\1\ICON:volume-2:24\ICON:volume-x:24\80x28\OUT:R:M10
P\lum_settimngs\Настройки светильника\TYPE:NEW\Настройки светильника независимо от его типа
  F\OUT:LT\IN:H
    I\ICON:back:36\48x48\OUT:L:M10\#111111\GOTOBACK
    C\Настройки\FONT:24\x48\OUT:L\#333333

  # Основной контент
  F\100%x100%\OUT:T:M10
    C\Название\OUT:LT:M5\IN:L\#333333
    F\100%x36\OUT:LT:M5\#FFFFFF\R8

    C\Иконка\OUT:LT:M5\IN:L\#333333
    F\100x100\OUT:LT:M5\#FFFFFF\R8\IN:M8
      I\ICON:sun:60\60x60\#333333

    C\Помещение\OUT:LT:M5\IN:L\#333333
    F\100%x36\OUT:LT:M5\#FFFFFF\R8\IN:H
      C\Не назначено\OUT:L:M8\IN:NW\#333333
      I\ICON:chevron-right:20\20x20\OUT:R:M8\#333333

    C\Группа\OUT:LT:M5\IN:L\#333333
    F\100%x36\OUT:LT:M5\#FFFFFF\R8\IN:H
      C\Не назначено\OUT:L:M8\IN:NW\#333333
      I\ICON:chevron-right:20\20x20\OUT:R:M8\#333333

    C\Минимальная яркость, %\OUT:LT:M5\IN:L\#333333
    F\100%x36\OUT:LT:M5\#FFFFFF\R8

    C\Максимальная яркость, %\OUT:LT:M5\IN:L\#333333
    F\100%x36\OUT:LT:M5\#FFFFFF\R8

    C\Плавность включения/выключения, сек\OUT:LT:M5\IN:L\#333333
    F\100%x36\OUT:LT:M5\#FFFFFF\R8

P\bright_sensor_settimngs\Настройки датчика освещенности\TYPE:NEW\Настройки датчика освещенности
  F\OUT:LT\IN:H
    I\ICON:back:36\48x48\OUT:L:M10\#111111\GOTOBACK
    C\Настройки\FONT:24\x48\OUT:L\#333333
  ...
  F\100%x100%\OUT:T:M10
    ...
    C\Иконка\OUT:LT:M5\IN:L\#AAAAAA
    F\100x100\OUT:LT:M5\#DDDDDD\R8\IN:M8
      I\ICON:sun:60\60x60\#AAAAAA
...
P\presence_sensor_settimngs\Настройки датчика присутствия\TYPE:NEW\Настройки датчика присутствия
  F\OUT:LT\IN:H
    I\ICON:back:36\48x48\OUT:L:M10\#111111\GOTOBACK
    C\Настройки\FONT:24\x48\OUT:L\#333333
  ...
  F\100%x100%\OUT:T:M10
    ...
    C\Задержка, сек\OUT:LT:M5\IN:L\#333333
    F\100%x36\OUT:LT:M5\#FFFFFF\R8

P\luminaire\Люстра\TYPE:NEW\Управление люстрой над столом
  # Навигация
  F\OUT:T\IN:H\100%x48
    I\ICON:back:36\48x48\OUT:L:M10\#111111\GOTOBACK
    C\Люстра\FONT:24\x48\OUT:L\IN:NW\#333333
    I\ICON:sliders:36\48x48\OUT:R:M10\#111111\GOTO:lum_settimngs\Настройки светильника

  # Основной контент
  F\100%x100%

  # Панель управления
  F\OUT:B:M0\100%x\#888888
    C\Цвет\FONT:16\x20\OUT:T:M5\IN:NW\#333333
    F\100%x16\OUT:T:M1\#FFFFFF\R8\IN:H
      F\20x20\#555555\R10\OUT:L
    C\Насыщенность\FONT:16\x20\OUT:T:M5\IN:NW\#333333
    F\100%x16\OUT:T:M1\#FFFFFF\R8\IN:H
      F\20x20\#555555\R10\OUT:L
    C\Температура\FONT:16\x20\OUT:T:M5\IN:NW\#333333
    F\100%x16\OUT:T:M1\#FFFFFF\R8\IN:H
      F\20x20\#555555\R10\OUT:L
    C\Яркость\FONT:16\x20\OUT:T:M5\IN:NW\#333333
    F\100%x16\OUT:T:M1\#FFFFFF\R8\IN:H
      F\20x20\#555555\R10\OUT:L
    F\IN:H\OUT:T:M5
      B\Выкл\70x40\OUT:M1
